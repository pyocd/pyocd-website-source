...
<div class="container px-4 py-1" id="features">
...
<div class="container px-4 pb-3" id="community">
...
<div class="row g-4 py-2 row-cols-1">
  <div class="col d-flex align-items-start">
    ...
    <div class="ms-3">
      <a href="https://github.com/pyocd/pyOCD"><h4>GitHub</h4></a>
      ...
      issues are a great place to look.
      </p>
    </div>
  </div>
  <div class="col d-flex align-items-start">
    ...
    <div class="ms-3">
      <a href="https://pyocd.slack.com"><h4>Slack</h4></a>
      <p>We have a public Slack workspace for live discussion and collaborative support of pyOCD and the
      other projects under the pyOCD umbrella. This is the place to go to get help, discuss ideas, and
      share tips with other users.</p>
    </div>
  </div>
  <div class="col d-flex align-items-start">
    <div class="feature-icon bg-light text-dark flex-shrink-0 me-3">
    ...
    <div class="ms-3">
      <a href="https://groups.google.com/g/pyocd"><h4>Mailing list</h4></a>
